# -*- coding: utf-8 -*-
# @Time : 2020/10/10 9:55
# @Author : Heng LI
# @FileName: constantScaling.py
# @Software: PyCharm
...
class ConstantScalingNet(nn.Module):
    def __init__(self):
        super(ConstantScalingNet, self).__init__()
        ...
        self.cBlock1 = ConstantScaling(16)
        self.cBlock2 = ConstantScaling(32)
